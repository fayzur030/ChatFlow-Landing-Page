...
const GlobalPayment = () => {
  return (
    <div className='grid grid-cols-12 gap-4 mt-10 lg:mx-6'>
      <section className='col-span-12 xl:col-span-10 xl:col-start-2 flex flex-col lg:flex-row items-center'>
        ...
        <div className='flex-1 flex flex-col justify-center'>
          <h1 className='text-3xl md:text-[52px] font-semibold text-[#FFFFFF] text-center md:text-left leading-snug md:leading-[1.2]'>
            Improve your customer <br className='hidden md:block lg:hidden' />{' '}
            experience with real- <br className='hidden md:block lg:hidden' />{' '}
            time assistance
          </h1>
          ...
          <p className='text-lg md:text-lg text-justify px-5 md:px-0 font-normal text-[#FFFFFF99] mt-3'>
            ...
            instantly, <br className='hidden md:block lg:hidden' /> boosting
            sales and improving customer satisfaction. Try it out today and{' '}
            <br className='hidden md:block lg:hidden' /> see the difference it
